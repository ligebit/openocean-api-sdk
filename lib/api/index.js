...
var Api = /** @class */ (function () {
    ...
    Api.prototype.getBalance = function (option) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._get("".concat(this.UrlOpenApi, "/v1/cross/getBalance"), option, RequestVo_1.ReqBanlanceVo)];
            });
        });
    };
    Api.prototype.getAllowance = function (option) {
        return this._get("".concat(this.UrlOpenApi, "/v1/cross/getAllowance"), option, RequestVo_1.ReqAllowanceVo);
    };
    ...
    Api.prototype.getTokenPrice = function (option) {
        return this._get("".concat(this.UrlCoingecKo, "/api/v3/simple/price"), option, RequestVo_1.ReqTokenPriceVo);
    };
    Api.prototype.getTokenInfo = function (option) {
        return this._get("".concat(this.UrlCoingecKo, "/api/v3/coins/").concat(option.id, "/contract/").concat(option.contract_address), option, RequestVo_1.ReqTokenInfoVo);
    };
    Api.prototype._validate = function (option, vo) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 2, , 3]);
                                    return [4 /*yield*/, this._validate(option, vo)];
                                case 1:
                                    errors = _a.sent();
                                    if (errors) {
                                        reject({
