...
var Api = /** @class */ (function () {
    ...
    Api.prototype.getGasPrice = function (option) {
        return (0, ajx_1.get)("".concat(this.UrlOpenApi, "/v1/").concat(option.chainId, "/getGasPrice"), option, RequestVo_1.ReqBase);
    };
    Api.prototype.quote = function (option) {
        return (0, ajx_1.get)("".concat(this.UrlOpenApi, "/v1/cross/quote"), option, RequestVo_1.ReqQuoteVo);
    };
    Api.prototype.swap = function (option) {
        return (0, ajx_1.get)("".concat(this.UrlOpenApi, "/v1/cross/swap_quote"), option, RequestVo_1.ReqSwapVo);
    };
    Api.prototype.getTokenList = function (option) {
        return (0, ajx_1.get)("".concat(this.UrlOpenApi, "/v1/cross/tokenList"), option, RequestVo_1.ReqBase);
    };
    Api.prototype.createWallet = function (option) {
        return (0, ajx_1.get)("".concat(this.UrlOpenApi, "/v1/cross/createWallet"), option, RequestVo_1.ReqBase);
    };
