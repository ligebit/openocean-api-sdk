...
exports.ReqtransferVo = exports.ReqTransactionVo = exports.ReqTransactionReceiptVo = exports.ReqSwapVo = exports.ReqQuoteVo = exports.ReqTokenInfoVo = exports.ReqTokenPriceVo = exports.ReqAllowanceVo = exports.ReqBanlanceVo = exports.ChainName = exports.ReqBase = void 0;
require("reflect-metadata");
var class_validator_1 = require("class-validator");
var class_transformer_1 = require("class-transformer");
var ChainIds = ['1', '3', '4', '56', '100', '137', '250', '42161', '43114'];
var ChainNames = ['bsc', 'eth', 'polygon', 'ftm', 'avax', 'heco', 'okex', 'xdai', 'arbitrum', 'optimism', 'moonriver', 'boba', 'ont', 'tron', 'solana', 'terra'];
var ReqBase = /** @class */ (function () {
    function ReqBase() {
    }
    __decorate([
        (0, class_validator_1.IsNotEmpty)({ message: 'ChainId addresses cannot be empty' }),
        (0, class_validator_1.IsIn)(ChainIds, { message: 'Chain id in(31/56/100/137/250/42161/43114)' }),
...
var ChainName = /** @class */ (function () {
    ...
    __decorate([
        (0, class_validator_1.IsNotEmpty)({ message: 'Chain addresses cannot be empty' }),
        (0, class_validator_1.IsIn)(ChainNames, { message: "Chain in()" }),
        (0, class_transformer_1.Type)(function () { return String; })
