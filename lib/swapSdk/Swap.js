...
var Swap = /** @class */ (function () {
    ...
    Swap.prototype.sendONTTransaction = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, approve, swap, transaction, _amount, symbol, inToken, instance_1, account;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.res, approve = _a.approve, swap = _a.swap, transaction = _a.transaction, _amount = _a._amount, symbol = _a.symbol, inToken = _a.inToken;
    ...
    Swap.prototype.sendOntTransaction = function (transaction) {
        return __awaiter(this, void 0, void 0, function () {
